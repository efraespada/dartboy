...
class Memory {
  ...
  void writeByte(int address, int value) {
    ...
    if (value > 0xFF) {
      throw new Exception('Tring to write ' +
  ...
  void writeIO(int address, int value) {
    ...
    if (address > 0xFF) {
      throw new Exception('Tring to write register ' +
          value.toRadixString(16) +
          ' into ' +
          address.toRadixString(16) +
          ' (>0xFF).');
  ...
  int readIO(int address) {
    if (address > 0xFF) {
      throw new Exception('Tring to read register from ' +
          address.toRadixString(16) +
          ' (>0xFF).');
    }
